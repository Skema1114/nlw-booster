    ...
    <>
      <View style={styles.container}>
        <TouchableOpacity onPress={handleNavigateBack}>
          <Text style={{ fontSize: 30, color: "#34cb79" }}>
      ...
      <View style={styles.itemsContainer}>
        ...
        >
          <TouchableOpacity style={styles.item} onPress={() => { }}>
            <SvgUri width={42} height={42} uri="http://192.168.1.202:3333/uploads/lampadas.svg" />
...
/**
 * SVGURI do pacote react-native-svg permite carregar um svg de uma url externa
 *
 */